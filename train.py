...
from util import _get_training_data, _get_test_data, show_sample
from model import Model
import json
import numpy as np
from random import randint

tf.app.flags.DEFINE_string('tf_records_train_path', 'C:/Users/Admin/Desktop/deep_learning _local_datasets/rt-polaritydata/tf_records/training_file_0.tfrecord',
                           'Path of the tfrecords files for training.'
                           )
tf.app.flags.DEFINE_string('tf_records_test_path', 'C:/Users/Admin/Desktop/deep_learning _local_datasets/rt-polaritydata/tf_records/test_file_0.tfrecord',
                           'Path of the tfrecords files for testing.'
                           )

tf.app.flags.DEFINE_string('word2idx', 'C:/Users/Admin/Desktop/deep_learning _local_datasets/rt-polaritydata/word2idx.txt',
